...
public class VendorController implements VendorApi {
    ...
    @Override
    public ResponseEntity<List<Long>> vendorRadiusPost(Long userID, String search, Location location) {
        try {
            return ResponseEntity.ok(vendorFacade.vendorsInRadius(userID, search, location));
